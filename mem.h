...
#define MTCLOCK		580000000
#define	RBUSFREQ	(MTCLOCK/3)
...
#define ICACHESIZE	(64*1024)		/* rb450g and mt7688*/
#define DCACHESIZE	(32*1024)		/* rb450g and mt7688 */
...
#define ROM		0xbfc00000		/* !! might be 0xB0118000 on mt7688 !! */
/* 0xBFC00000 is mentioned as the Reset Vector in the ARM to Mips guide from Mips */
...
#define MEMSIZE	(128*MB)		/* fixed RAM on onion omega 2 plus */
//#define PCIMEM	0x10000000		/* on rb450g */
/* different pci on omega 2 */


#define	CONFADDR	(KZERO+0x19000)		/* info passed from boot loader */
